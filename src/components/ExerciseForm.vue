<template>
  <div class="game-form">
    <v-btn @click="dialog = !dialog" color="primary"> Add new Exercise</v-btn>

    <v-dialog v-model="dialog" persistent width="600px">
      <v-card>
        <v-card-title> Add new Exercise </v-card-title>
        <v-card-text>
...
<script>
import { tagsCollection, exerciseCollection, auth } from "../firebase";
  ...
  methods: {
    ...
    async addExercise() {
      try {
        ...
        // //upload file
        // const fileRef = "uploads/Exercise/" + this.file.name;
        ...
        this.checkIfNewTags();
        await exerciseCollection.add(data);
